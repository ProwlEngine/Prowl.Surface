...
public readonly struct PixelRect : IEquatable<PixelRect>
{
    ...
    /// <param name="scale">The scaling factor.</param>
    /// <returns>The device-independent rect.</returns>
    public Rect ToRect(Vector2 scale) => new Rect(Position.ToPoint(scale), Size.ToSize(scale));
    ...
    /// <param name="dpi">The dots per inch of the device.</param>
    /// <returns>The device-independent rect.</returns>
    public Rect ToRectWithDpi(Vector2 dpi) => new Rect(Position.ToPointWithDpi(dpi), Size.ToSizeWithDpi(dpi));
    ...
    public static PixelRect FromRect(Rect rect, Vector2 scale) => new PixelRect(
        PixelPoint.FromPoint(rect.Position, scale),
    ...
    public static PixelRect FromRectWithDpi(Rect rect, double dpi) => new PixelRect(
        ...
        FromPointCeiling(rect.BottomRight, new Vector2(dpi / 96, dpi / 96)));
    ...
    /// <param name="dpi">The dots per inch of the device.</param>
    /// <returns>The device-independent point.</returns>
    public static PixelRect FromRectWithDpi(Rect rect, Vector2 dpi) => new PixelRect(
        PixelPoint.FromPointWithDpi(rect.Position, dpi),
    ...
    private static PixelPoint FromPointCeiling(Vector2 point, Vector2 scale)
    {
