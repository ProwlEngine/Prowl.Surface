...
static class MathUtilities
{
    ...
    public static Vector2 GetEllipsePoint(Vector2 centre, double radiusX, double radiusY, double angle)
    {
        return new Vector2(radiusX * Math.Cos(angle) + centre.x, radiusY * Math.Sin(angle) + centre.y);
    }
