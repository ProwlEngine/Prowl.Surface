...
public readonly partial struct PixelPoint : IEquatable<PixelPoint>
{
    ...
    /// <summary>
    /// Converts the <see cref="PixelPoint"/> to a device-independent <see cref="Vector2"/> using the
    /// specified scaling factor.
    /// </summary>
    /// <param name="scale">The scaling factor.</param>
    /// <returns>The device-independent point.</returns>
    public Vector2 ToPoint(double scale) => new Vector2(X / scale, Y / scale);
    ...
    /// <param name="scale">The scaling factor.</param>
    /// <returns>The device-independent point.</returns>
    public Vector2 ToPoint(Vector2 scale) => new Vector2(X / scale.x, Y / scale.y);
    ...
    /// <returns>The device-independent point.</returns>
    public Vector2 ToPointWithDpi(double dpi) => ToPoint(dpi / 96);
    ...
    /// <param name="dpi">The dots per inch of the device.</param>
    /// <returns>The device-independent point.</returns>
    public Vector2 ToPointWithDpi(Vector2 dpi) => ToPoint(new Vector2(dpi.x / 96, dpi.y / 96));
    ...
    /// <param name="scale">The scaling factor.</param>
    /// <returns>The device-independent point.</returns>
    public static PixelPoint FromPoint(Vector2 point, double scale) => new PixelPoint(
        (int)(point.x * scale),
        (int)(point.y * scale));
    ...
    /// <param name="scale">The scaling factor.</param>
    /// <returns>The device-independent point.</returns>
    public static PixelPoint FromPoint(Vector2 point, Vector2 scale) => new PixelPoint(
        (int)(point.x * scale.x),
        (int)(point.y * scale.y));
    ...
    /// <param name="dpi">The dots per inch of the device.</param>
    /// <returns>The device-independent point.</returns>
    public static PixelPoint FromPointWithDpi(Vector2 point, double dpi) => FromPoint(point, dpi / 96);
    ...
    /// <param name="dpi">The dots per inch of the device.</param>
    /// <returns>The device-independent point.</returns>
    public static PixelPoint FromPointWithDpi(Vector2 point, Vector2 dpi) => FromPoint(point, new Vector2(dpi.x / 96, dpi.y / 96));
