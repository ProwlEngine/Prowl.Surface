...
using Prowl.Surface.Platform.Storage.FileIO;

using static Prowl.Surface.X11.NativeDialogs.Glib;
using static Prowl.Surface.X11.NativeDialogs.Gtk;

namespace Prowl.Surface.X11.NativeDialogs;
...
internal class GtkSystemDialog : BclStorageProvider
{
    ...
    private static void UpdateParent(IntPtr chooser, IWindowBaseImpl parentWindow)
    {
