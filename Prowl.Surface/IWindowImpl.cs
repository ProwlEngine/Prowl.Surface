...
public interface IWindowImpl : IWindowBaseImpl
{
    ...
    void Resize(Vector2 clientSize, WindowResizeReason reason = WindowResizeReason.Application);
    ...
    /// </summary>
    ///
    void SetMinMaxSize(Vector2 minSize, Vector2 maxSize);
