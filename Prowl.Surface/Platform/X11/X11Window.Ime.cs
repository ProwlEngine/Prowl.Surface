...
//using Prowl.Surface.Input.TextInput;
...
internal partial class X11Window
{
    ...
    private void TriggerClassicTextInputEvent(ref XEvent ev)
    {
        ...
        if (text != null)
            ScheduleInput(
                new RawTextInputEventArgs(_keyboard, (ulong)ev.KeyEvent.time.ToInt64(), _inputRoot, text, (RawInputModifiers)ev.KeyEvent.state),
                ref ev);
    }
