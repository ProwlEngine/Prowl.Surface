...
public class ClipboardTests
{
    ...
    {
        var text = "Hello World from ★ Prowl.Surface ★";
    ...
    {
        var text = "Hello World from Prowl.Surface 2";
    ...
    {
        var text = "<p>Hello World from Prowl.Surface</p>";
    ...
    {
        {
            var format = Clipboard.Register<byte[]>("Prowl.Surface-MyTestCustomFormat-bytes");
            var buffer = new byte[] { 1, 2, 3, 4 };
        ...
        }
        {
            ...
            var format = Clipboard.Register<string>("Prowl.Surface-MyTestCustomFormat-string");
